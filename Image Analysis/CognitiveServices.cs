...
namespace ComputerVisionQuickstart
{
  ...
  // Add your Computer Vision subscription key and endpoint
        static string subscriptionKey = Environment.GetEnvironmentVariable("AZURE_VISION_KEY") ?? "PASTE_YOUR_COMPUTER_VISION_SUBSCRIPTION_KEY_HERE";
        static string endpoint = Environment.GetEnvironmentVariable("AZURE_VISION_ENDPOINT") ?? "https://YOUR_ENDPOINT.cognitiveservices.azure.com/";
        // </snippet_vars>
...
private const string ANALYZE_LOCAL_IMAGE = "celebrities.jpg";
        ...
        private const string ANALYZE_URL_IMAGE = "https://images.pexels.com/photos/4021773/pexels-photo-4021773.jpeg";
     // </snippet_analyze_url>
